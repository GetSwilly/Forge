...
public class CameraShake : MonoBehaviour {
	...
	[SerializeField] float shakeTime = .75f;

	[SerializeField] float shakeAmountMajor = 0.7f;
	[SerializeField] float shakeAmountMinor = 0.5f;
	[SerializeField] float shakeAmountMini = 0.1f;
